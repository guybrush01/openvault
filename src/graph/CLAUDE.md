...
- **Semantic Merge**: `mergeOrInsertEntity` — fast path for exact key match, slow path uses embedding similarity (threshold 0.8) to dedupe same-type entities. Stores embedding on nodes.
